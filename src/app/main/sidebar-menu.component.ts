...
@Component({
  ...
  <div class="c-nav" c-custom-scrollbar>
    ...
    <ul  class="c-sidebar-menu" [hidden]="!searchMsgHidden">
        ...
        <li>
          <a href="http://36.155.126.15:32068/dashboard/db/cluster?orgId=1" target="_blank">
          <i class="fa fa-tree"></i> 
          <span class="nav-label">系统性能监控</span>
          </a>
        </li>
        <li>
          <a href="http://111.207.243.66:8001/APIindex.html" target="_blank">
          <i class="fa fa-cogs"></i> 
          <span class="nav-label">API组合编排系统</span>
          </a>
        </li>
        <li>
          <a href="http://10.108.210.102:30000/dist/codegen.html#" target="_blank">
          <i class="fa fa-cube"></i> 
					<span class="nav-label">SDK打包</span>
				  </a>
        </li>
    </ul>
  </div>
