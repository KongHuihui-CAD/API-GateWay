...
@Component({
  selector: 'app-create-atom-api',
  templateUrl: './create-atom-api.component.html',
  styleUrls: ['./create-atom-api.component.scss']
})

export class CreateAtomApiComponent implements OnInit {
  data = "";
  para = "";
  //地区的数据
